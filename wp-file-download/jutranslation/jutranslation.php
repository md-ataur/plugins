 ...
 *
 * @package Joomunited\WPFileDownload\Jutranslation
 */

namespace Joomunited\WPFileDownload\Jutranslation;
...
class Jutranslation
{
    ...
    public static function init($main_plugin_file, $extension_slug, $extension_name, $text_domain, $language_file)
    {
        ...
        add_action('admin_init', function () {
             ...
             */
            $wpfd_can_translate = apply_filters('wpfd_user_can', current_user_can('manage_options'), 'translate_plugin');
            if ($wpfd_can_translate) {
        ...
        foreach ($languages as &$language) {
            ...
            if (file_exists($file)) {
                ...
                foreach ($mo->entries as $entry) {
                    ...
                    if (isset($entry->translations) && is_countable($entry->translations) && count($entry->translations)) {
                        $language->overrided++;
                    }
                }
            }
