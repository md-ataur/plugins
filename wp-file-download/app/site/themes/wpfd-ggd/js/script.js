...
jQuery(document).ready(function ($) {
    ...
    function load(sourcecat, catid, page) {
        ...
        var ordering = $(".wpfd-content-ggd.wpfd-content-multi[data-category=" + sourcecat + "]").find('#current_ordering').val();
        var orderingDirection = $(".wpfd-content-ggd.wpfd-content-multi[data-category=" + sourcecat + "]").find('#current_ordering_direction').val();
        var params = $.param({
            task: 'files.display',
            view: 'files',
            id: catid,
        ...
        window.wpfdAjax[ggd_root_cat].file = $.ajax({
            ...
            gdd_init_pagination($('.wpfd-content-ggd + .wpfd-pagination'));
    ...
    function gdd_init_pagination($this) {
        ...
        var wrap = $this.prevUntil('.wpfd-content-ggd');
        ...
        number.unbind('click').bind('click', function () {
            ...
            var current_category = $(".wpfd-content-ggd[data-category=" + current_sourcecat + "]").find('#current_category_' + sourcecat).val();
            if (typeof page_number !== 'undefined') {
                var pathname = window.location.href.replace(window.location.hash, '');
                var category = $(".wpfd-content-ggd[data-category=" + current_sourcecat + "]").find('#current_category_' + sourcecat).val();
                var category_slug = $(".wpfd-content-ggd[data-category=" + current_sourcecat + "]").find('#current_category_slug_' + sourcecat).val();
                var ordering = $(".wpfd-content-ggd[data-category=" + current_sourcecat + "]").find('#current_ordering_' + sourcecat).val();
                var orderingDirection = $(".wpfd-content-ggd[data-category=" + current_sourcecat + "]").find('#current_ordering_direction_' + sourcecat).val();
