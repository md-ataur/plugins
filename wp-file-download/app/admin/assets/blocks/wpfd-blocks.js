      ...
      value: function render() {
        ...
        return preview ? wp.element.createElement("img", { alt: __('WP File Download Category', 'wpfd'), width: "100%", src: previewImageData }) : wp.element.createElement(
          ...
          wp.element.createElement(
              ...
              showInput ? wp.element.createElement(
                ...
                showCategoryList && wp.element.createElement(
                  ...
                  loading ? wp.element.createElement(
                    ...
                    "ul",
                    null,
                    categoriesList.length > 0 ? filteredCategoriesList.length > 0 ? filteredCategoriesList.map(function (category, index) {
                      var haveChild = typeof categoriesList[index + 1] !== 'undefined' && categoriesList[index + 1].level > 0;
            ...
            catName !== '' && selectedCategoryId && showInput === false && wp.element.createElement(
              "div",
              { className: "wpfd-selected-category-name" },
      ...
      value: function render() {
        ...
        return preview ? wp.element.createElement("img", { alt: __('WP File Download File', 'wpfd'), width: "100%", src: previewImageData }) : wp.element.createElement(
          ...
          wp.element.createElement(
            ...
            filename !== '' && wp.element.createElement(
              "div",
              { className: "wpfd-selected-file-name" },
              __('FILE NAME', 'wpfd'),
              ":",
              wp.element.createElement(
                "span",
