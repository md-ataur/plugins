<?php
/*
Plugin Name: Registration Form Customize
Plugin URI:
...
/* Show on the user profile */
add_action(
    'show_user_profile',
    'rfp_user_profile_phone_number'
);
 
/* Show on the other user profile who has the capability ( Suppose Admin ) */
add_action(
    'edit_user_profile',
    'rfp_user_profile_phone_number'
);
...
/* Update the user profile value who has the capability ( Suppose Admin ) */
add_action(
